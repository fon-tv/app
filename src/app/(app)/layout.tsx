...
export default function AppLayout({
	...
	return (
		<div className="flex flex-col lg:pt-[200px]">
			<div className="z-10 flex flex-col justify-between bg-background mx-0 lg:mx-auto px-[23px] pt-[55px] lg:pt-[49px] pb-[49px] lg:rounded-lg w-[1440px] max-w-[100%] min-h-lvh">
